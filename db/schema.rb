...
ActiveRecord::Schema.define(version: 2020_04_27_165014) do
  ...
  create_table "category_filters", force: :cascade do |t|
    ...
    t.index ["item_id"], name: "index_category_filters_on_item_id"
  end
  ...
  create_table "reviews_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_reviews_items_on_item_id"
    t.index ["review_id"], name: "index_reviews_items_on_review_id"
  end
